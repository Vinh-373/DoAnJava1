...
('Dell XPS 13', 'Intel i7', '16GB', '512GB', 'NVIDIA GTX 1650', '6h', '1.2kg', 25000000, 100, 50, 1, 1, 'xps13.jpg', '13.3"', 'Windows 10', 1),
('HP Pavilion', 'Intel i5', '8GB', '256GB', 'Intel UHD', '5h', '1.5kg', 15000000, 200, 150, 2, 2, 'pavilion.jpg', '15.6"', 'Windows 10', 1),
('Lenovo ThinkPad X1', 'Intel i7', '16GB', '512GB', 'Intel Iris Plus', '8h', '1.3kg', 30000000, 50, 30, 3, 3, 'thinkpad.jpg', '14"', 'Windows 10', 1);
...
INSERT INTO SERI_PRODUCT (num_seri, id_product, status) VALUES
('SP001', 1, 1),
('SP002', 2, 1),
('SP003', 3, 1);
GO
...
INSERT INTO BILL_IMPORT (id_admin, id_product, unit_price, total_price, quantity, date_import) VALUES
(1, 1, 22000000, 44000000, 2, '2024-04-01'),
(2, 2, 15000000, 30000000, 2, '2024-04-05'),
(1, 3, 16000000, 32000000, 2, '2024-04-10');
GO
-- Thêm dữ liệu vào bảng SERI_PRODUCT
INSERT INTO SERI_PRODUCT (num_seri, id_product, status) VALUES
('SR001', 1, 1),   -- Mã số seri cho sản phẩm ASUS TUF Gaming F15
('SR002', 1, 1),   -- Mã số seri khác cho sản phẩm ASUS TUF Gaming F15
('SR003', 2, 1),   -- Mã số seri cho sản phẩm DELL Inspiron 15
('SR004', 3, 1);   -- Mã số seri cho sản phẩm HP Pavilion
GO
-- Thêm dữ liệu vào bảng BILL_EXPORT_DETAIL
INSERT INTO BILL_EXPORT_DETAIL (id_bill_ex, id_product, num_seri, unit_price) VALUES
