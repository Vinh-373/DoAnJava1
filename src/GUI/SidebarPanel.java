...
public class SidebarPanel extends JPanel {
    ...
    public SidebarPanel() {
        ...
        ImageIcon icon = ImageLoader.loadImage("src/images/manager.png");
        if (icon != null) {
        ...
        String[][] menuItems = {
                {"Trang chủ", "src/images/home.png"},
                {"Sản phẩm", "src/images/product.png"},
                {"Tài khoản", "src/images/account.png"},
                {"Khách hàng", "src/images/customer.png"},
                {"Đơn hàng", "src/images/order.png"},
                {"Hóa đơn", "src/images/order.png"},
                {"Nhà cung cấp", "src/images/supplier.png"},
                {"Kho hàng", "src/images/import.png"},
                {"Bảo hành", "src/images/warranty.png"},
                {"Thống kê", "src/images/statistics.png"},
                {"Đăng xuất", "src/images/logout.png"}
        };
        ...
        for (String[] item : menuItems) {
            ImageIcon iconItem = ImageLoader.loadImage(item[1]);
            if (iconItem != null) {
